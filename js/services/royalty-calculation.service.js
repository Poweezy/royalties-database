...
class RoyaltyCalculationService {
    ...
    calculateRoyalty(params) {
        ...
        try {
            switch (calculationType) {
                ...
                case 'ad_valorem':
                    return this.calculateAdValorem(volume, price, calculationParams.percentage);
    ...
    calculateProgressive(volume, params) {
        ...
        if (volume > threshold) {
            ...
            const progressionMultiplier = 1 + (excess / threshold) * progressionFactor;
     ...
     */
    calculatePenalties(dueDate, currentDate = new Date(), baseAmount, penaltyType = 'monthly') {
        ...
        return {
            ...
            daysPastDue,
            breakdown,
            penaltyRate: penaltyType === 'monthly' 
    ...
    getSuggestedCalculationMethod(mineral) {
        const suggestions = {
            ...
            'Gold': { method: 'ad_valorem', reason: 'Precious metal with volatile prices' },
            'Diamond': { method: 'ad_valorem', reason: 'High value precious stone' },
            'Quarried Stone': { method: 'fixed', reason: 'Stable low-value commodity' },
