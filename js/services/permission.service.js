  ...
  initializeDefaultPermissions() {
    const permissions = [
      ...
      // Royalty Management
      {
        ...
        description: "View royalty records",
      },
      {
        id: "royalties.create",
        name: "Create Royalties",
        category: "Royalty Management",
        description: "Create new royalty records",
      },
      {
        id: "royalties.edit",
        name: "Edit Royalties",
        category: "Royalty Management",
        description: "Modify royalty records",
      },
      {
        id: "royalties.delete",
        name: "Delete Royalties",
        category: "Royalty Management",
        description: "Delete royalty records",
      },
      {
        id: "royalties.approve",
        name: "Approve Royalties",
        category: "Royalty Management",
        description: "Approve royalty payments",
      },
